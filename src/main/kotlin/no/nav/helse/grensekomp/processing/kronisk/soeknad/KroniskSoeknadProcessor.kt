package no.nav.helse.grensekomp.processing.kronisk.soeknad
...
class KroniskSoeknadProcessor(
    ...
    fun journalfør(soeknad: KroniskSoeknad): String {
        val journalfoeringsTittel = "Søknad om grensekomp fra arbeidsgiverperioden ifbm kronisk lidelse"
    ...
    private fun createDocuments(
        ...
        val dokumentListe = mutableListOf(
            Dokument(
                ...
                brevkode = "soeknad_om_grensekomp_fra_agp_kronisk",
                tittel = journalfoeringsTittel,
            )
        )
    ...
    fun opprettOppgave(soeknad: KroniskSoeknad): String {
        ...
        val request = OpprettOppgaveRequest(
            ...
            beskrivelse = """
                Søknad om grensekomp fra arbeidsgiverperioden ifbm kronisk lidelse
            """.trimIndent(),
            tema = "SYK",
    ...
    fun opprettFordelingsOppgave(soeknad: KroniskSoeknad): String {
        ...
        val request = OpprettOppgaveRequest(
            ...
            journalpostId = soeknad.journalpostId,
            beskrivelse = """
                Fordelingsoppgave for søknad om grensekomp fra arbeidsgiverperioden grunnet kronisk sykdom.
            """.trimIndent(),
            tema = "SYK",
            behandlingstype = digitalSoeknadBehandingsType,
