...
class KroniskSoeknadAltinnKvitteringSender(
    ...
    fun mapKvitteringTilInsertCorrespondence(kvittering: KroniskSoeknad): InsertCorrespondenceV2 {
        ...
        val tittel = "Kvittering for mottatt søknad om grensekomp fra arbeidsgiverperioden grunnet kronisk sykdom"
        ...
        <html>
           ...
           <body>
               <div class="melding">
            <p>Kvittering for mottatt søknad om grensekomp fra arbeidsgiverperioden grunnet risiko for høyt sykefravær knyttet til kronisk sykdom.</p>
