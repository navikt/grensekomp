...
class KroniskKravProcessor(
    ...
    companion object {
        ...
        val dokumentasjonBrevkode = "krav_om_grensekomp_fra_agp_dokumentasjon"
    }
    ...
    fun journalfør(krav: KroniskKrav): String {
        val journalfoeringsTittel = "Krav om grensekomp fra arbeidsgiverperioden ifbm kroniskitet"
    ...
    private fun createDocuments(
        ...
        val dokumentListe = mutableListOf(
            Dokument(
                ...
                brevkode = "krav_om_grensekomp_fra_agp_kronisk",
                tittel = journalfoeringsTittel,
            )
        )
    ...
    fun opprettFordelingsOppgave(krav: KroniskKrav): String {
        ...
        val request = OpprettOppgaveRequest(
            ...
            journalpostId = krav.journalpostId,
            beskrivelse = """
                Fordelingsoppgave for refusjonskrav ifbm sykdom i aprbeidsgiverperioden med grensekomp fra arbeidsgiverperioden grunnet kronisk sykdom.
            """.trimIndent(),
            tema = "SYK",
            behandlingstype = digitalKravBehandingsType,
