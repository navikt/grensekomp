...
import no.nav.helse.grensekomp.processing.brukernotifikasjon.BrukernotifikasjonProcessor.Jobbdata.SkjemaType.GravidSøknad
...
class GravidSoeknadProcessor(
    ...
    companion object {
        ...
        val dokumentasjonBrevkode = "soeknad_om_grensekomp_fra_agp_dokumentasjon"
    }
    override val type: String get() = JOB_TYPE

    val digitalSoeknadBehandingsType = "ae0227"
    val grensekompBehandingsTema = "ab0338"
    ...
    fun journalfør(soeknad: GravidSoeknad): String {
        val journalfoeringsTittel = "Søknad om grensekomp fra arbeidsgiverperioden ifbm graviditet"
    ...
    private fun createDocuments(
        ...
        val dokumentListe = mutableListOf(
            Dokument(
                ...
                brevkode = "soeknad_om_grensekomp_fra_agp_gravid",
                tittel = journalfoeringsTittel,
            )
        )
    ...
    fun opprettOppgave(soeknad: GravidSoeknad): String {
        ...
        val request = OpprettOppgaveRequest(
            ...
            beskrivelse = """
                Søknad om grensekomp fra arbeidsgiverperioden ifbm. graviditet
            """.trimIndent(),
            tema = "SYK",
            behandlingstype = digitalSoeknadBehandingsType,
            oppgavetype = "BEH_SAK",
            behandlingstema = grensekompBehandingsTema,
    ...
    fun opprettFordelingsOppgave(soeknad: GravidSoeknad): String {
        ...
        val request = OpprettOppgaveRequest(
            ...
            journalpostId = soeknad.journalpostId,
            beskrivelse = """
                Fordelingsoppgave for søknad om grensekomp fra arbeidsgiverperioden grunnet gravid sykdom.
            """.trimIndent(),
            tema = "SYK",
            behandlingstype = digitalSoeknadBehandingsType,
